...
<body>
    <div class="container bg-white p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="<?= base_url() ?>/Login"
                            onclick="return confirm('Anda belum login, silahkan login terlebih dahulu')"
                            class="nav-item nav-link">Pesan Tiket</a>
                        <?php } ?>
                    ...
                    <a href="<?= base_url(); ?>/Login/logout"
                        class="btn btn-light rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Keluar</a>
                    <?php } else { ?>
                    <a href="<?= base_url(); ?>/Login"
                        class="btn btn-light rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Masuk</a>
                    <?php } ?>
                </div>
            </nav>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <?php if (session()->get('log_in') == true) { ?>
                            <h4 class="text-white mb-4 animated slideInDown">Selamat datang
                                <?= session()->get('nama'); ?></h4>
                            <?php } ?>
                            <h1 class="text-white mb-4 animated slideInDown">Selamat datang di website kami</h1>
                            <p class="text-white pb-3 animated slideInDown">Silahkan melakukan pemesanan tiket anda
                                melalui tombol dibawah.</p>
                            ...
                            <?php if (session()->get('log_in') == true) { ?>
                            <a href="<?= base_url() ?>/pesantiket" class="btn btn-light rounded-pill btn-lg">Pesan
                                Tiket</a>
                            <?php } else { ?>
                            <a href="<?= base_url() ?>/login"
                                onclick="return confirm('Anda belum login, silahkan login terlebih dahulu')"
                                class="btn btn-light rounded-pill btn-lg">Pesan Tiket</a>
                            <?php } ?>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid rounded animated zoomIn" src="<?= base_url(); ?>/img/awal.png"
                                alt="kapal" width="80%">
                        </div>
                    </div>
                </div>
        ...
        <!-- Testimonial Start -->
        <div class="container py-6" id="testimonial">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
        ...
        <!-- Contact Start -->
        <div class="container py-6" id="contact">
            <div class="container">
                <div class="row g-5">
        ...
        <div class="container-fluid bg-dark text-body footer wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="container px-lg-5">
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">Copyright © <?= date('Y') ?>.
                            <a href="https://anakdesapk.blogspot.com/" target="_blank">Sorong Developer</a>
                        </div>
                    </div>
                </div>
            </div>
